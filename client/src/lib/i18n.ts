...
const translations = {
  tr: {
    ...
    'hero.subtitle': 'Çorap Üretiminde Dijital Dönüşüm',
    'hero.cta': 'Hemen Başlayın',
    'hero.cta.primary': 'Hemen Başlayın',
    'hero.cta.secondary': 'Dijital Yolculuğu Keşfet',
  ...
  en: {
    ...
    'hero.subtitle': 'Digital Transformation in Sock Production',
    'hero.cta': 'Get Started',
    'hero.cta.primary': 'Get Started',
    'hero.cta.secondary': 'Explore Digital Journey',
